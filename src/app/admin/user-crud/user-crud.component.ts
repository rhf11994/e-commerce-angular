...
export class UserCrudComponent implements OnInit {
  ...
  get name() {
    return this.addEditUserForm.get('name')!;
  }

  get nickname() {
    return this.addEditUserForm.get('nickname')!;
  }
  ...
  get password() {
    return this.addEditUserForm.get('password')!;
  }

  get mobNumber() {
    return this.addEditUserForm.get('mobNumber')!;
  }
  get age() {
    return this.addEditUserForm.get('age')!;
  }
  get dob() {
    return this.addEditUserForm.get('age')!;
  }
  get addLine1() {
    return this.addEditUserForm.get('addLine1')!;
  }
 get city() {
    return this.addEditUserForm.get('city')!;
  }
 get state() {
    return this.addEditUserForm.get('state')!;
  }
 get zipCode() {
    return this.addEditUserForm.get('zipCode')!;
  }
 get language() {
    return this.addEditUserForm.get('language')!;
  }
 get gender() {
    return this.addEditUserForm.get('gender')!;
  }
 get aboutYou() {
    return this.addEditUserForm.get('aboutYou')!;
  }
get uploadPhoto() {
    return this.addEditUserForm.get('uploadPhoto')!;
  }
get agreetc() {
    return this.addEditUserForm.get('agreetc')!;
  }
get role() {
    return this.addEditUserForm.get('role')!;
  }
